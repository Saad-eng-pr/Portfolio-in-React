        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 h-full'>
            <div className='flex flex-col gap-5 relative sm:p-10 px-5 shadow-2xl shadow-black-200'>
              <div className='absolute top-0 right-0'>
                <img src={currentProject.spotlight} alt="spotligh" className='w-full h-96 object-cover rounded-xl'/>
              </div>
            ...
            <div className="border border-black-300 bg-black-200 rounded-lg h-96 md:h-full">
              <Canvas>
                ...
                <OrbitControls maxPolarAngle={Math.PI / 2} maxDistance={6} minDistance={3.5}/>
              </Canvas>
            </div>
        </div>
    </section>
